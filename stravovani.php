...
<body>
    ...
    <main>
        <h2>Stravování</h2>
        <ul class="kr-ul">
            <li class="li-style"><a class='kr-link' href="stravovani1.php">První stupeň</a></li>
            <li class="li-style"><a class='kr-link' href="stravovani2.php">Druhý stupeň</a></li>
        </ul>
    </main>
    <footer class="footer">
        <div class="contacts">
