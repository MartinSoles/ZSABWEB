...
<body>
    ...
    <main class="f-main">
        <h2>Stravování prvního stupně </h2>
        <?php 
            $json_data = file_get_contents('./data/stravovani1/stravovani1.json');
            $json_data = json_decode($json_data, true);    
            foreach ($json_data as  $item){
                $par = htmlspecialchars($item['stravovani1']);
