...
<body>
    ...
    <main class="f-main">
        <h2>Stravování druhého stupně </h2>
        <?php 
            $json_data = file_get_contents('./data/stravovani2/stravovani2.json');
            $json_data = json_decode($json_data, true);    
            foreach ($json_data as  $item){
                $par = htmlspecialchars($item['stravovani2']);
